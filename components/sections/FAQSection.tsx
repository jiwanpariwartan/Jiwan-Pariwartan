        ...
        <div className="grid lg:grid-cols-5 gap-16 items-start">
          ...
          <div className="lg:col-span-2">
            <SectionTitle
              ...
              subtitle="We understand this journey raises many questions. Here are the answers to the most common ones."
              centered={false}
            />
            <div className="mt-10 p-6 rounded-2xl bg-gradient-to-br from-purple-600 to-violet-500 text-white">
              ...
              <p className="text-purple-100 text-sm mb-5 leading-relaxed">
                Our counselors are available 24/7 to answer your questions confidentially.
              </p>
              <a
