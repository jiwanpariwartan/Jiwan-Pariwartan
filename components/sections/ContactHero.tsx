...
export default function ContactHero() {
  return (
    <section className="relative min-h-[55vh] flex items-end overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-purple-950 via-violet-900 to-purple-900" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-28 w-full">
        ...
        >
          ...
          <h1 className="font-display font-bold text-5xl sm:text-6xl lg:text-7xl text-white leading-tight mb-6 max-w-3xl">
            ...
            <span className="gradient-text-purple">With One Call</span>
          </h1>
          <p className="text-lg text-gray-300 max-w-2xl leading-relaxed mb-8">
            Reaching out is the first and most important step. Our compassionate team is available 24/7 for free, confidential consultations.
          </p>
