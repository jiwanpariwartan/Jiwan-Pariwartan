  ...
  return (
    <section className="relative min-h-[55vh] flex items-end overflow-hidden">
      ...
      <div className="absolute inset-0"
        style={{
          backgroundImage:
            "radial-gradient(ellipse at 40% 60%, rgba(167,139,250,0.18) 0%, transparent 50%), radial-gradient(ellipse at 70% 20%, rgba(212,175,55,0.08) 0%, transparent 50%)",
        }}
      />
      <div
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-28 w-full">
        ...
        >
          ...
          <h1 className="font-display font-bold text-5xl sm:text-6xl lg:text-7xl text-white leading-tight mb-6 max-w-3xl">
            Spaces Designed to{" "}
            <span className="gradient-text-purple">Heal & Restore</span>
          </h1>
          <p className="text-lg text-gray-300 max-w-2xl leading-relaxed">
            Every corner of Jiwan Pariwartan has been thoughtfully designed to promote calm, safety, and healing — a sanctuary where transformation begins.
          </p>
        </motion.div>
      </div>
